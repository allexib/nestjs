...
export class AddRelationsBetweenArticleAndUser1645610275163 implements MigrationInterface {
  name = 'AddRelationsBetweenArticleAndUser1645610275163';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "articles" ADD CONSTRAINT "FK_61dc60abcf0035e5ce2aea013bc" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
